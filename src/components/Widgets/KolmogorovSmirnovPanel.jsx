...
export default function WelchesTTestPanel(props) {
  return (
    <PanelStatistics 
      widgetType="kolmogorovsmirnov" 
      props={props} 
      CalculateComponent={CalculateKolmogorovSmirnovTest}
    />
  );
}
          ...
          <Fragment key={idx}>
            <Table size='sm' >
              ...
              <tbody className='small text-center'>
                ...
                <tr>
                  <th className='text-start'>d-Statistic</th>
                  <td>{numberFormat(itm.dStatistic)}</td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td>{itm.sampleSize1} - {itm.sampleSize2}</td>
                </tr>
                <tr>
            ...
            <p className='small px-2' key={idx+'i'}>{interpretKolmogorovSmirnovTest(itm, confidenceLevel)}</p>
          </Fragment>
        )  
      }
    </>
