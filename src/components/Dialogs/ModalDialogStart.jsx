        ...
        <Row className='text-center my-4'>
          <Col className='border-end px-4'>
            <Button onClick={() => { props.onHide(); props.setAnalysisModal(true); }} variant="outline-primary" className='w-100'>
              ...
              <span className='d-block text-body-secondary fw-bold'>New Analysis</span>
              <small className='d-block text-body-secondary'>Import data from a file</small>
            </Button>
          </Col>
          <Col className='px-4'>
            <Button onClick={() => { props.onHide(); props.setLoadAnalysis(true); }} variant="outline-primary" className='w-100'>
              ...
              <span className='d-block text-body-secondary fw-bold'>Load Analysis</span>
              <small className='d-block text-body-secondary'>Continue your work</small>
            </Button>
          </Col>
        </Row>
        <Row>
