  ...
  return (
    ...
    >
      ...
      <Modal.Footer className='flex-nowrap p-0'>
        <Button onClick={() => props.onHide(true)} onKeyDown={(e) => { if (e.key === 'enter') props.onHide(true) }} variant='link' className='fs-6 text-decoration-none col-6 m-0 rounded-0 border-end'><strong className="text-danger">{props.yes || 'Yes'}</strong></Button>
